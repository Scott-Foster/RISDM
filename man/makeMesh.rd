...
\item{expandRegion}{Should the survey region be expanded beyond the boundary defined by the raster? Default is TRUE, and should nearly always be TRUE. Honestly, this parameter and the functionality is a legacy of trying bug-hunt.}
