...
\item{int.sd}{The standard deviation for the Gaussian prior for the intercept values. Default value is 1000. Ignored if prior.list is specified.}
...
\item{other.sd}{The standard deviation for the Gaussian prior for the `fixed' effects. Default is 10. Does not include any of the intercepts. Ignored if prior.list is specified is specified.}
