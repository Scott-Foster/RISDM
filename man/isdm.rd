...
\item{int.sd}{The standard deviation for the Gaussian prior for the intercept values. Default value is 1000. Ignored if prior.list or int.prec is specified.}
\item{int.prec}{The precision for the Gaussian prior for the intercept values. Default value is 1/(int.sd^2), with int.sd=1000 by default. Ignored if either prior.list or int.sd are specified.}
\item{other.sd}{The standard deviation for the Gaussian prior for the `fixed' effects. Default is 10. Does not include any of the intercepts. Ignored if prior.list is specified or if other.prec is specified.}
\item{other.prec}{The precision for the Gaussian prior for the `fixed' effects. Default is 1/(other.sd^2), with other.sd=10 by default. Does not include any of the intercepts. Ignored if either prior.list or other.sd is specified.}
