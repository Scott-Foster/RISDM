...
\item{ habitatArea}{A character giving the name of a layer of covarBrick that corresponds to the amount of area within each cell of the raster brick that is suitable habitat for the species.}
