...
\usage{
 isdm( POdat=NULL, PAdat=NULL, AAdat=NULL, covarBrick=NULL,
	mesh=NULL, boundary=NULL,
        responseNames=NULL, sampleAreaNames=NULL,
        distributionFormula=NULL,
        biasFormulas=list( PO=~1, PO=~1, AA=~1),
        control=list())
}
\arguments{
\item{ POdat}{A data.frame containing at least the spatial locations of the presences in the presence-only data. Default is NULL, implying that there is no PO data. Note that at least one of POdat, PAdat and AAdat must be non-NULL.}
...
\item{ AAdat}{A data.frame containing at least the spatial locations and the abundancemeasure at sampled locations. Abundance measure must be able to include zero. Default is NULL. See POdat.}
...
\details{ This function is an implementation of the methods described in Isaac et al. (2020). It is even based on their code-base and can be seen as a wrapper. There are a few changes to the original code, but the idea and intuition remains the same.
